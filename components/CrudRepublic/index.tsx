...
const CrudRepublic = () => {
  return (
        <div className="bg-white md:ml-0 w-full flex items-center flex-col">
          <h2 className="mt-6 mb-3 text-xl sm:text-sm md:text-5xl font-bold text-center text-gray-900">Cadastre seu imóvel</h2>
          <form>
            <div className="grid mt-24 md:grid-cols-2 md:gap-6">
            ...
            <button type="submit" className="w-30 block mb-8 md:mb-0 bg-sky-500 hover:bg-sky-400 focus:bg-sky-400 text-white font-semibold rounded-lg
    px-4 py-3 mt-4 md:mt-6">Registrar imóvel</button>
          </form>
        </div>
  )
}
