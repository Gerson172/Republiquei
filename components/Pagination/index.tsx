...
<nav aria-label="Page navigation example">
  <ul className="inline-flex items-center -space-x-px">
    ...
    <li>
      <a href="#" aria-current="page" className="z-10 py-2 px-3 leading-tight text-white bg-blue-500 border border-blue-500 dark:border-gray-700 dark:bg-gray-700 dark:text-white">3</a>
    </li>
    <li>
