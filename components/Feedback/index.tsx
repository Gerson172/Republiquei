					...
					<div className="grid gap-4 md:grid-cols-2">
						<div className="grid content-center gap-4">
							<div className="p-6 rounded shadow-md dark:bg-gray-900">
								...
								<div className="flex items-center mt-4 space-x-4">
									<img className="w-12 h-12 bg-center bg-cover rounded-full dark:bg-gray-500" src="https://source.unsplash.com/50x50/?portrait?1" alt="img" />
									<div>
							...
							<div className="p-6 rounded shadow-md dark:bg-gray-900">
								...
								<div className="flex items-center mt-4 space-x-4">
									<img className="w-12 h-12 bg-center bg-cover rounded-full dark:bg-gray-500" src="https://source.unsplash.com/50x50/?portrait?2" alt="img" />
									<div>
										<p className="text-lg font-semibold">Leroy Jenkins</p>
						...
						<div className="grid content-center gap-4">
							<div className="p-6 rounded shadow-md dark:bg-gray-900">
								...
								<div className="flex items-center mt-4 space-x-4">
									<img className="w-12 h-12 bg-center bg-cover rounded-full dark:bg-gray-500" src="https://source.unsplash.com/50x50/?portrait?3" alt="img" />
									<div>
										<p className="text-lg font-semibold">Leroy Jenkins</p>
							...
							<div className="p-6 rounded shadow-md dark:bg-gray-900">
								...
								<div className="flex items-center mt-4 space-x-4">
									<img className="w-12 h-12 bg-center bg-cover rounded-full dark:bg-gray-500" src="https://source.unsplash.com/50x50/?portrait?4" alt="" />
									<div>
										<p className="text-lg font-semibold">Leroy Jenkins</p>
