	...
	return (
		<section className="flex flex-col gap-8 w-10/12 h-full">
			...
			<p className="text-[#212529] font-roboto font-normal text-base leading-[18.75px] w-[700px] text-left align-middle">
				Adicione uma descrição do seu imóvel, seja criativo e use esse campo
				para falar todos os pontos importantes do seu imóvel, regras, despesas
				extras, comodidades, como são os moradores e o que você desejar.
			</p>
