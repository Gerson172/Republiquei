	...
	return (
		<section className="flex flex-col gap-8 w-10/12">
			...
			<p className="text-[#212529] font-roboto font-normal text-base leading-[18.75px] text-left align-middle">
				Adicione as regras de convivência e comodidade da sua república,
				ajudando a filtrar o melhor público para alugar a república.
			</p>
			<form className="space-t-2">
				...
				<div className="grid grid-cols-3 gap-4">
					<div>
						<h2 className="my-4 font-semibold text-gray-900 dark:text-white">
						...
						<div className="flex items-center">
							<button
								...
								onClick={() =>
									setValue('quantidadeBanheiros', quantidadeBanheiros - 1)
								}
							>
					...
					<div>
						...
						<div className="flex items-center">
							<button
								...
								className="flex items-center bg-red-500 text-white w-6 h-6 btn-circle justify-center"
								onClick={() =>
									setValue('quantidadeQuartos', quantidadeQuartos - 1)
								}
							>
								<FaMinus className="text-white" />
							</button>
