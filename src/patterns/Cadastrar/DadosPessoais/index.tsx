            ...
            <div className="grid sm:grid-cols-1 md:grid-cols-4 md:gap-6">
                ...
                <div className="relative z-0 mb-6 w-full group">
                    ...
                    <input
                        ...
                        className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                    />
                    {errors.sobrenome && <span className="text-sm text-red-500">{errors.sobrenome.message}</span>}
                </div>
                <div className="relative z-0 mb-6 w-full group">
                ...
                <div className="relative z-0 mb-6 w-full group">
                    ...
                    <input
                        ...
                        className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                    />
                    {errors.dataNascimento && <span className="text-sm text-red-500">{errors.dataNascimento.message}</span>}
                </div>
            </div>
