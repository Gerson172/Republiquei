...
const orientacaoSexual = [
	{
		value: 'Selecione sua orientação sexual',
		label: 'Selecione sua orientação sexual',
	},
...
const tipoSexoImovel = [
	{
		value: 'Selecione o tipo de sexo do quarto',
		label: 'Selecione o tipo de sexo do quarto',
	},
