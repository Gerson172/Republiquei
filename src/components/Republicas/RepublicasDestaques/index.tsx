...
export function RepublicasDestaques() {
  ...
  return (
    <main className={`flex ${isFetching ? "flex-col" : "flex-row"}  md:flex-row w-full flex-wrap bg-gray-100 justify-center gap-4 text-center py-16`}>
      <div className="py-16">
      ...
      <div className={`flex ${isFetching ? "flex-col" : "flex-row"} flex flex-col md:flex-row flex-wrap mb-8 justify-center`}>
        {isFetching ? <Loading /> :
      ...
      <div>
        ...
        className="px-12 py-4 bg-sky-500 text-white">Ver mais repúblicas
        </Link>
      </div>
    </main>
  )
