...
function CardRepublicas(props: Imovel) {
	...
	return (
		<div className="md:flex md:justify-center max-sm:w-screen my-4">
			<div className="w-full md:w-[24rem] px-4">
				<Link href={`republica/${props.idImovel}`}>
					<div className="border-2 rounded-lg drop-shadow-md bg-white">
						...
						<div>
							<h5
								className={`text-xl text-center truncate px-4 font-semibold tracking-tight text-gray-900`}
							>
								{props.nomeImovel}
							</h5>
