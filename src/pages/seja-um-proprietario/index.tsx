						...
						<div className="mx-auto">
							<div className="flex flex-wrap flex-row-reverse items-center">
								<div className="md:w-1/2 lg:w-2/3 lg:pl-20 md:pl-10 sm:pl-0 pl-0">
									<div className="py-2 text-color">
										<h1 className="text-2xl lg:text-6xl md:leading-snug tracking-tighter f-f-l font-black">
											Anuncie grátis para mais de 8 mil usuários
										</h1>
										<h2 className="text-sm lg:text-2xl leading-7 md:leading-10 f-f-r py-8">
											Existem milhares de potenciais inquilinos na sua área à
											procura de um imóvel para chamar de lar. Com a Republiquei
											você pode atingir o universitário que mais combina com o
											seu imóvel.
										</h2>
									</div>
								</div>
								<div className="lg:w-1/3 md:w-1/2 w-full relative flex items-end justify-center">
									<Image
										alt="Adulto de meia idade comemorando uma venda, ele é um homem branco e está com um braço pra cima e com o punho cerrado"
							...
							<div className="flex flex-wrap items-center pb-12">
								<div className="md:w-1/2 lg:w-2/3 w-full xl:pr-20 md:pr-6">
									<div className="py-2 text-color">
										...
										<h2 className="text-sm lg:text-2xl leading-7 md:leading-10 f-f-r py-8">
											Republiquei resolve as principais dores de cabeça de
											possuir uma propriedade: anunciar o imóvel e encontrar
											inquilinos. Entregamos um produto que vai transformar a
											experiência de alugar seu imóvel.
										</h2>
